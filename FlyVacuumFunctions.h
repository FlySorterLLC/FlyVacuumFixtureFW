...
enum {
  GATE_MOTOR_SPEED = 100,
  NEEDLE_MOTOR_SPEED = 200,
  SWITCH_DEBOUNCE_READS = 5,
  NEEDLE_MOTOR_TIMEOUT_MS = 500,
  GATE_MOTOR_TIMEOUT_MS = 250,
  POST_DISPENSE_WAIT_MS = 500,
  PHOTOGATE_TIMEOUT_MS = 5000,
  NEEDLE_CAPTURE_DURATION_MS = 1000,
  CAPTURE_ATTEMPTS = 2,
  NOMINAL_VACUUM_THRESHOLD = 400,
  CAPTURE_PRESSURE_THRESHOLD = 100,
  PRESSURE_READING_COUNT = 8,
